...
<div class="home-page-hero-sidebar | d-flex d-xl-none f-column pos-fixed pb-40 pi-20 gap-40">
    ...
    <div class="sidebar-social-icons-wrapper | d-flex jc-center gap-12 ">
        <img class="sidebar-social-icons | bg-natural-900 radius-8 p-8"
            src="<?php echo get_template_directory_uri() . '/assets/img/icon-test-2-white.png' ?>" alt="test-icon">
        <img class="sidebar-social-icons | bg-natural-900 radius-8 p-8"
            src="<?php echo get_template_directory_uri() . '/assets/img/icon-test-3-white.png' ?>" alt="test-icon">
        <img class="sidebar-social-icons | bg-natural-900 radius-8 p-8"
            src="<?php echo get_template_directory_uri() . '/assets/img/icon-test-4-white.png' ?>" alt="test-icon">
    </div>
