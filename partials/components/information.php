...
?>
    ...
    <div class="information-cta-icon-wrapper pos-relative pos-md-static">
    ...
    <div class="information-cta-btn m-be-120">
        ...
        <a class="cta-btn d-flex ai-start gap-8 pi-20 pb-16 radius-12 text-natural-100 fs-body-sm" href="<?php echo esc_url($btn_url); ?>"><?php echo esc_html($btn_title); ?>
