<div class="info-card box-col-3 gap-116">
    ...
    <div
        class="time-section-1-wrapper col-span-1 col-span-md-3 col-span-lg-3 d-lg-flex d-none jc-center ai-center gap-4">
    ...
    <div
        class="time-section-2-wrapper col-span-1 col-span-md-3 col-span-lg-3 d-lg-flex d-none jc-center ai-center gap-4">
    ...
    <div
        class="time-section-3-wrapper col-span-1 col-span-md-3 col-span-lg-3 d-lg-flex d-none jc-center ai-center gap-4">
