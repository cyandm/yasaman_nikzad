            ...
            <div class="col-span-9 txt-blog">
                <div class="d-sm-flex jc-between">
                    ...
                    <div class="d-none d-sm-block fs-body-1">
                        <img class="d-sm-none" src="<?php echo get_template_directory_uri() . '/assets/img/icon-test-1.png' ?>" alt="search">
                ...
                <div class="d-flex gap-36">
                    <div class="d-sm-none d-block fs-body-1">
                        <img src="<?php echo get_template_directory_uri() . '/assets/img/icon-test-1.png' ?>" alt="search">
                        <time datetime="<?php echo get_the_date('c'); ?>" itemprop="datePublished"><?php echo get_the_date('Y/m/d'); ?></time>
                    </div>
                    <div class="d-sm-none d-block fs-body-1">
                        <img src="<?php echo get_template_directory_uri() . '/assets/img/icon-test-1.png' ?>" alt="search">
