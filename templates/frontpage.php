    ...
    <div class="home-page-hero-wrapper">
        ...
        <div class="home-page-hero-sidebar | d-flex f-column gap-80 ai-center pb-40 pi-20">
            ...
            <div class="sidebar-social-icons">
                <img src="<?php //echo get_template_directory_uri() . '/assets/img/icon-test-2-white.png' ?>" alt="test-icon">
                <img src="<?php //echo get_template_directory_uri() . '/assets/img/icon-test-3-white.png' ?>" alt="test-icon">
                <img src="<?php //echo get_template_directory_uri() . '/assets/img/icon-test-4-white.png' ?>" alt="test-icon">
            </div>
    ...
    <section class="get-in-touch-section"> <!-- get in touch -->
        <div>
            <div>
                ...
                <form class="d-grid gap-24  pos-relative" method="post" name="contact">
