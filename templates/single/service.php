...
<main class="main-service pos-relative">
    ...
    <div class="time-line-info-wrapper d-flex f-column jc-center gap-60 m-bs-108">
        <div class="time-line-wrapper d-flex jc-evenly ">
            <div class="time-section-1 fs-h2"><?php echo get_field("hours") ?><span class="fs-title-2">Hours</span>
            </div>
            <img src="<?php echo get_template_directory_uri() . '/assets/img/icon-test-6.png' ?>" alt="arrow">
            <div class="time-section-2 fs-h2"><?php echo get_field("days") ?><span class="fs-title-2">Days</span></div>
            <img src="<?php echo get_template_directory_uri() . '/assets/img/icon-test-6.png' ?>" alt="arrow">
            <div class="time-section-3 fs-h2"><?php echo get_field("weeks") ?><span class="fs-title-2">Weeks</span>
            </div>
        </div>
